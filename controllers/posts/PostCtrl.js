...
const cloudinaryUoloadImage = require("../../utils/cloudinary");
const fs = require("fs");
...
if(isDisiked){
 ...
 module.exports ={createPostCtrl, fetchPostsCtrl, fetchPostCtrl, updatePostCtrl, deletePostCtrl, toggleLikesToPostCtrl, toggleDislikesToPostCtrl}